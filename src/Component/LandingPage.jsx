  ...
  return (
    <>
      <div className="landing" style={{backgroundImage:`url(${landing})`,  backgroundSize:"cover", backgroundPosition:"center"}}>
        <div className="text-center pt-48 mx-auto">
            <h1 className="vanContent text-xl md:text-4xl lg:text-5xl sm:text-1xl">You got the travel plans, we got the travel vans.</h1>
            <p className="vanDetails pt-10 text-lg md:text-1xl lg:text-xl sm:text-sm">Add adventure to your life by joining the #vanlife movement. Rent the perfect van to make your perfect road trip.</p>
